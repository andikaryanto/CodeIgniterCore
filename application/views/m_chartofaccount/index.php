                  ...
                  <div class="row">
                    ...
                    <div class="col">
                      <div class="text-right">
                        <button type="button" rel="tooltip" class="btn btn-primary btn-round btn-fab" title="<?= lang('ui_add')?>" onclick="window.location.href='<?= base_url('mchartofaccount/add');?>'">
                      ...
                      <div class="row">
                        <div class="col-sm-12">
                          <div class="table-responsive">
                            <table data-page-length="-1" id = "tableCity" class="table table-striped table-no-bordered table-hover dataTable dtr-inline collapsed" cellspacing="0" width="100%" style="width: 100%;" role="grid" aria-describedby="datatables_info">
                                  ...
                                  <?php }?>
                                    <!-- <td>
                                      <div class="input-group has-success">
                                        <input id = "parentname" type="text" class="form-control custom-readonly"  value="" readonly>
  ...
  function dataTable(){
    ...
    $('a.toggle-vis').on( 'click', function (e) {
     ...
     table.on( 'click', '.edit', function () {
        ...
        var id = $tr.attr('id');
        window.location = "<?= base_url('mchartofaccount/edit/');?>" + id;
     } );
     ...
     table.on( 'click', '.delete', function (e) {
        ...
        deleteData(data[0], function(result){
          if (result==true)
          {
            ...
            $.ajax({
              type : "POST",
              url : "<?= base_url('mchartofaccount/delete/');?>",
              data : {id : id},
