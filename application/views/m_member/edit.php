    ...
    <div class="row">
      <div class="col-md-12">
        <div class="card">
          ...
          <div class="card-body">                 
            <form method = "post" action = "<?= base_url('mmember/editsave');?>">
              <input hidden name ="idmember" id="idmember" value="<?= $model->Id?>">
              <div class = "row">
                <div class = "col-md-8">
                  <div class="form-group">
                    <label><?= lang('ui_number')?></label>
                    <input id="number" type="text"  class="form-control" name = "number" placeholder ="<?= $model->NoMember?>" disabled>
                  </div>
                </div>
                <div class = "col-md-4">
                ...
                <div class = "col-md-6">
                  <div class="form-group">
                    ...
                    <div class="input-group has-success">
                      ...
                      <input id = "instancename" type="text" class="form-control custom-readonly"  value="<?= $model->get_M_Instance()->Owner."/".$model->get_M_Instance()->InstanceName?>" readonly>
              ...
              <div class="col-sm-12">
                <div class="table-responsive">
                  <table data-page-length="<?= $_SESSION['usersettings']['RowPerpage']?>" id = "tablemodalPeoples" class="table table-striped table-no-bordered table-hover dataTable dtr-inline collapsed" cellspacing="0" width="100%" style="width: 100%;" role="grid" aria-describedby="datatables_info">
                    ...
                    <tbody>
                    <?php
                        foreach ($datamodal['modal_people'] as $value)
                        {
                          $class = "";
                          if($value->IsMember == 0 ) {
                            $class = "rowdetail";
              ...
              <div class="col-sm-12">
                <div class="table-responsive">
                  <table data-page-length="<?= $_SESSION['usersettings']['RowPerpage']?>" id = "tablemodalInstances" class="table table-striped table-no-bordered table-hover dataTable dtr-inline collapsed" cellspacing="0" width="100%" style="width: 100%;" role="grid" aria-describedby="datatables_info">
                    ...
                    <tbody>
                    <?php
                        foreach ($datamodal['modal_instance'] as $value)
                        {
                          $class = "";
                          if($value->IsMember == 0 ) {
                            $class = "rowdetail";
