          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  ...
                  <div class="row">
                    <div class="col">
                      ...
                      <p class="card-category"> <?= lang('ui_master_loan')?></p>
                    </div>
                    <div class="col">
                      <div class="text-right">
                        <button type="button" rel="tooltip" class="btn btn-primary btn-round btn-fab" title="index" onclick="window.location.href='<?= base_url('mloan');?>'">
                ...
                <div class="card-body">                 
                  <form method = "post" action = "<?= base_url('mloan/editsave');?>">
                    <input hidden name ="idloan" id="idloan" value="<?= $model->Id?>">
