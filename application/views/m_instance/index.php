              ...
              <div class="card">
                  ...
                  <div class="row">
                    ...
                    <div class="col">
                      <div class="text-right">
                        <button type="button" rel="tooltip" class="btn btn-primary btn-round btn-fab" title="<?= lang('ui_add')?>" onclick="window.location.href='<?= base_url('minstance/add');?>'">
                ...
                <div class="card-body">
                  ...
                  <div class="material-datatables">
                    <div>
                      Toggle column: <a href="#" class="toggle-vis text-primary" data-column="0"><?=  lang('ui_owner')?></a> - 
                                      <a href="#" class="toggle-vis text-primary" data-column="1"><?=  lang('ui_instancename')?></a> - 
                                      <a href="#" class="toggle-vis text-primary" data-column="2"><?=  lang('ui_address')?></a> - 
                                      <a href="#" class="toggle-vis text-primary" data-column="3"><?=  lang('ui_createat')?></a>
                    </div>
  ...
  function dataTable(){
    ...
    $('a.toggle-vis').on( 'click', function (e) {
     ...
     table.on( 'click', '.edit', function () {
        ...
        var id = $tr.attr('id');
        window.location = "<?= base_url('minstance/edit/');?>" + id;
     } );
